/**
 * Rational Equation — Learnosity Custom Scorer v13 (server-side)
 *
 * v13: structural DN (dropdowns in math positions) — a RENDERING-ONLY change;
 * scorer logic is byte-identical to v10 (DN scoring is value equality,
 * position-agnostic; completedSections tracking unchanged).
 *
 * v10: SC/MC sub-step types added (no scorer logic changes needed —
 * completedSections tracking is identical for SC/MC).
 *
